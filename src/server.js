...
function pagepescar(req, res){
    const filters = req.query
    return res.render("pescar.html", {proffys, filters, subjects, weekdays})
}
...
//Rotas da aplicação
.get("/", pageLanding)
.get("/pescar", pagepescar)
.get("/profi", pageGiveClasses)
//Start do servidor
.listen(5500)